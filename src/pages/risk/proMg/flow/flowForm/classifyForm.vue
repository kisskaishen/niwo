        ...
        <el-form class="classifyForm" :model="classifyForm" status-icon :rules="rules">
            <el-form-item label="">
                ...
                <el-input v-else class="w310" v-model="classifyForm.categoryName"
                          :class="{'solid_red':vLock&&!classifyForm.categoryName}" placeholder="请输入分类器名称"
...
<script>
    import {ajax} from '../flowMixin/ajax'

    import policyItem from '../../../../../components/pc/policy/policyItem'

    export default {
        name: 'pages_flowClassifyForm',
        data() {
            return {
                loading: true,
        ...
        methods: {
            ...
            validateClassifyForm() {
                ...
                console.log(this.classifyForm.policyList)
            ...
            //     query.policyType = 2;
            //     this.$router.push({path: '/risk/proMg/businessList/editFlow/classifyForm/stratForm', query: query});
            // },
            pushStrat(stratForm) {
                ...
                this.$router.push({path: '/risk/proMg/businessList/editFlow/classifyForm', query: this.$route.query});
            },
            /************************ 与varItem公用的方法 ************************/
