        ...
        <el-form class="scoreCard" :model="scoreCard" status-icon ref="scoreCard">
            <el-form-item>
                <el-select :popper-append-to-body="true" class="w310"
                           ...
                           filterable placeholder="请选择决策流模型" size="medium" no-match-text="查询无结果" no-data-text="暂无数据"
        ...
        methods: {
            getScorecardList() {
                this.$post('/mcs/mold/config/list', {
                    ...
                    .then(res => {
                        ...
                        Object.assign(this.scoreCard, res.moldList[0])
            ...
            bindscoreCard() {// 3.2.50模型配置--绑定AB测试节点
                if (this.$route.query.from == 'kingForm') {
                    ...
                    this.$router.push(this.$route.fullPath.replace('/outFrandForm', '/kingForm'))
                } else {
