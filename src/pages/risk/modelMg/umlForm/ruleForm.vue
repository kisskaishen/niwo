        ...
        methods: {
            ...
            arrowLeft() {// 返回
                ...
                if (this.$route.name == 'strat_ruleForm') {// 返回策略
                    this.$router.push({path: '/risk/modelMg/modelUml/stratForm', query: this.$route.query});
                } else if (this.$route.name == 'parallelForm_ruleForm' || this.$route.name == 'parallelForm_stratForm_ruleForm') {// 返回策略
