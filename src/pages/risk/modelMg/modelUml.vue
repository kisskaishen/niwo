<template>
    <div class="pages_modelUml" v-loading="loading">
        <!--<breadcrumb></breadcrumb>-->
        <div class="uml_hd">
            <div class="titleDiv" v-if="$route.query.type=='edit'">
                <p>模型名称：
                    <el-input v-model="modelAdd.moldName" @blur="modelNameChange(modelAdd.moldName)"></el-input>
                </p>
            ...
            <div class="menuDiv">
                <div class="uml_back" id="uml_back" @click="goBack('/risk/modelMg/modelList')">
                ...
                <div class="uml uml_classify" id="uml_classify" data-nodetype="3" :draggable="draggable"
                     @dragstart="dragstart($event)" @drag="drag($event)" @dragend="dragend($event)"
                     data-modal='/risk/modelMg/modelUml/classifyForm'>
                ...
                <div class="uml uml_strat" id="uml_strat" data-nodetype="4" :draggable="draggable"
                     @dragstart="dragstart($event)" @drag="drag($event)" @dragend="dragend($event)"
                     data-modal='/risk/modelMg/modelUml/stratForm' v-if="$route.query.moldType==1">
                    ...
                    <div class="kingDiv" v-if="$route.query.type=='edit'">
                        <i class="iconAdd" data-modal='/risk/modelMg/modelUml/kingForm'
                ...
                <div class="uml uml_parallel" id="uml_parallel" data-nodetype="7" :draggable="draggable"
                     @dragstart="dragstart($event)" @drag="drag($event)" @dragend="dragend($event)"
                     data-modal='/risk/modelMg/modelUml/parallelForm' v-if="$route.query.moldType==1">
                ...
                <!--<div class="uml uml_test" id="uml_test" data-nodetype="7" :draggable="draggable&&!hasNode.abTest" @dragstart="dragstart($event)"  @drag="drag($event)" @dragend="dragend($event)" data-modal='/risk/modelMg/modelUml/testAB' v-if="$route.query.moldType==1">
                    <div class="uml_icon" alt="B测试"></div>
                    <p class="uml_title">A/B测试</p>
                </div>-->
                <div class="uml uml_scoreCard" id="uml_scoreCard" data-nodetype="5" data-needmoldtype="4"
                     :draggable="draggable"
                     @dragstart="dragstart($event)" @drag="drag($event)" @dragend="dragend($event)"
                     data-modal='/risk/modelMg/modelUml/scoreCardForm' v-if="$route.query.moldType==3">
                ...
                <div class="uml uml_calculator" id="uml_calculator" data-nodetype="6" :draggable="draggable"
                     @dragstart="dragstart($event)" @drag="drag($event)" @dragend="dragend($event)"
                     data-modal='/risk/modelMg/modelUml/computecard' v-if="$route.query.moldType==3">
        ...
        <transition name="slide-fade">
            <div class="uml_form bg_fff pd_l_20 pd_r_20 scrollY" v-if="show.policyType&&$route.name!='modelUml'">
...
<script>
    ...
    import {reqData, xyCorrect, h5Drag, pageOpr} from './umlMixin/initFn'
    import {revoke} from './umlMixin/revoke'
    import {oprDom, umlDomFn, selectFn} from './umlMixin/oprDom'
    import {ajax, ajaxPush} from './umlMixin/ajax'
    ...
    export default {
        ...
        methods: {
            revoke() {// 撤销
                if (this.$route.query.type == 'edit') {
                    ...
                    console.log('可以撤销的步骤', this.pointer)
            ...
            recovery() {// 恢复
                if (this.$route.query.type == 'edit') {
                    console.log(this.his)
                    console.log('可以恢复的步骤', this.pointer)
                ...
                if (this.$route.query.type == 'edit') {
                    jsPlumb.draggable(node, {// 添加拖拽事件
                        ...
                        drag: (info) => {
                            ...
                            // console.log(document.getElementById('uml_bd').style.height)
        ...
        watch: {
            '$route'(val) {
                if (val.path == '/risk/modelMg/modelUml') {
